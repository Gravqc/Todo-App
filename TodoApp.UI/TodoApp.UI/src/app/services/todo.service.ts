...
export class TodoService {
  ...
  baseApiUrl:string = 'https://localhost:7084';
  ...
  getAllDeletedTodos():Observable<Todo[]>{
    return this.http.get<Todo[]>(this.baseApiUrl + '/api/Todo/' + 'deleted-todo');
  }

  undoDelete(id:string, todo:Todo):Observable<Todo>{
    return this.http.put<Todo>(this.baseApiUrl + "/api/Todo/deleted-todo/" + id, todo);
